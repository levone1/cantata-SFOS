...
QT_MOC_LITERAL(1, 15, 10), // "hasChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "changed"
QT_MOC_LITERAL(4, 35, 4), // "load"
QT_MOC_LITERAL(5, 40, 8), // "defaults"
QT_MOC_LITERAL(6, 49, 6) // "commit"

    },
    "ShortcutsModel\0hasChanged\0\0changed\0"
    "load\0defaults\0commit"
};
...
void ShortcutsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ShortcutsModel *_t = static_cast<ShortcutsModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hasChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->load(); break;
        case 2: _t->defaults(); break;
        case 3: _t->commit(); break;
        case 4: { bool _r = _t->hasChanged();
        ...
        {
            typedef void (ShortcutsModel::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ShortcutsModel::hasChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ShortcutsModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_ShortcutsModel.data,
      qt_meta_data_ShortcutsModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ShortcutsModel::hasChanged(bool _t1)
{

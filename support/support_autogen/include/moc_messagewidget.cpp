...
void MessageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->visible((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MessageWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageWidget::visible)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MessageWidget::staticMetaObject = {
    { &KMsgWidget::staticMetaObject, qt_meta_stringdata_MessageWidget.data,
...
void *MessageWidget::qt_metacast(const char *_clname)
{
    ...
    return KMsgWidget::qt_metacast(_clname);
}

int MessageWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = KMsgWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
...
// SIGNAL 0
void MessageWidget::visible(bool _t1)
{

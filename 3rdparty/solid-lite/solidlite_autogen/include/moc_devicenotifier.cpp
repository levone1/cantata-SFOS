...
void Solid::DeviceNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeviceNotifier *_t = static_cast<DeviceNotifier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DeviceNotifier::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeviceNotifier::deviceAdded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DeviceNotifier::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeviceNotifier::deviceRemoved)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Solid::DeviceNotifier::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Solid__DeviceNotifier.data,
      qt_meta_data_Solid__DeviceNotifier,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Solid::DeviceNotifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Solid__DeviceNotifier.stringdata0))
        return static_cast<void*>(const_cast< DeviceNotifier*>(this));

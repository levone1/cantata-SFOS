...
#include "../../backends/udisks2/udisksstoragevolume.h"
...
const QMetaObject Solid::Backends::UDisks2::StorageVolume::staticMetaObject = {
    { &Block::staticMetaObject, qt_meta_stringdata_Solid__Backends__UDisks2__StorageVolume.data,
      qt_meta_data_Solid__Backends__UDisks2__StorageVolume,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Solid::Backends::UDisks2::StorageVolume::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Solid::Ifaces::StorageVolume"))
        return static_cast< Solid::Ifaces::StorageVolume*>(const_cast< StorageVolume*>(this));

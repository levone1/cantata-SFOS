...
QT_MOC_LITERAL(5, 83, 14), // "QVariantMapMap"
QT_MOC_LITERAL(6, 98, 25), // "interfaces_and_properties"
QT_MOC_LITERAL(7, 124, 21), // "slotInterfacesRemoved"
QT_MOC_LITERAL(8, 146, 10), // "interfaces"
QT_MOC_LITERAL(9, 157, 16), // "slotMediaChanged"
QT_MOC_LITERAL(10, 174, 12), // "QDBusMessage"
QT_MOC_LITERAL(11, 187, 3) // "msg"
...
void Solid::Backends::UDisks2::Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotInterfacesAdded((*reinterpret_cast< const QDBusObjectPath(*)>(_a[1])),(*reinterpret_cast< const QVariantMapMap(*)>(_a[2]))); break;
...
const QMetaObject Solid::Backends::UDisks2::Manager::staticMetaObject = {
    { &Solid::Ifaces::DeviceManager::staticMetaObject, qt_meta_stringdata_Solid__Backends__UDisks2__Manager.data,
      qt_meta_data_Solid__Backends__UDisks2__Manager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};

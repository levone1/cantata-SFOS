...
QT_MOC_LITERAL(1, 5, 11), // "viewChanged"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 5), // "abort"
QT_MOC_LITERAL(4, 24, 13), // "setScaleImage"
QT_MOC_LITERAL(5, 38, 1) // "s"

    },
    "View\0viewChanged\0\0abort\0setScaleImage\0"
    "s"
};
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setScaleImage((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View::viewChanged)) {
                *result = 0;
                return;
            }
        }

...
QT_MOC_LITERAL(1, 18, 13), // "settingsSaved"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 8), // "showPage"
QT_MOC_LITERAL(4, 42, 4), // "page"
QT_MOC_LITERAL(5, 47, 13) // "writeSettings"

    },
    "PreferencesDialog\0settingsSaved\0\0"
    "showPage\0page\0writeSettings"
};
...
void PreferencesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreferencesDialog::settingsSaved)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PreferencesDialog::staticMetaObject = {
    { &ConfigDialog::staticMetaObject, qt_meta_stringdata_PreferencesDialog.data,
...
void *PreferencesDialog::qt_metacast(const char *_clname)
{
    ...
    return ConfigDialog::qt_metacast(_clname);
}

int PreferencesDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ConfigDialog::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)

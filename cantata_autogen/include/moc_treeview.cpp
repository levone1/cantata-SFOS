...
QT_MOC_LITERAL(3, 24, 13), // "itemActivated"
QT_MOC_LITERAL(4, 38, 5), // "index"
QT_MOC_LITERAL(5, 44, 16), // "correctSelection"
QT_MOC_LITERAL(6, 61, 14) // "itemWasClicked"

    },
    "TreeView\0itemsSelected\0\0itemActivated\0"
    "index\0correctSelection\0itemWasClicked"
};
...
void TreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->itemActivated((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 2: _t->correctSelection(); break;
        case 3: _t->itemWasClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TreeView::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TreeView::itemsSelected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TreeView::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TreeView::itemActivated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TreeView::itemsSelected(bool _t1)
{
...
// SIGNAL 1
void TreeView::itemActivated(const QModelIndex & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

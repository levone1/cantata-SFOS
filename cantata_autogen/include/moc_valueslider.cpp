/****************************************************************************
** Meta object code from reading C++ file 'valueslider.h'
**
...
#error "The header file 'valueslider.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 32, 15) // "onSliderChanged"

    },
    "ValueSlider\0valueChanged\0\0value\0"
    "onSliderChanged"
};
...
void ValueSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ValueSlider *_t = static_cast<ValueSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ValueSlider::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ValueSlider::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ValueSlider::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ValueSlider.data,
      qt_meta_data_ValueSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ValueSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ValueSlider.stringdata0))
        return static_cast<void*>(const_cast< ValueSlider*>(this));
...
// SIGNAL 0
void ValueSlider::valueChanged(int _t1)
{

...
struct qt_meta_stringdata_JamendoService_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_JamendoService_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_JamendoService_t qt_meta_stringdata_JamendoService = {
    {
QT_MOC_LITERAL(0, 0, 14) // "JamendoService"
...
const QMetaObject JamendoService::staticMetaObject = {
    { &OnlineDbService::staticMetaObject, qt_meta_stringdata_JamendoService.data,
      qt_meta_data_JamendoService,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JamendoService::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JamendoService.stringdata0))
        return static_cast<void*>(const_cast< JamendoService*>(this));
    return OnlineDbService::qt_metacast(_clname);
}

int JamendoService::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = OnlineDbService::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}

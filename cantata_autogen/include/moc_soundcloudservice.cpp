...
struct qt_meta_stringdata_SoundCloudService_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SoundCloudService_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SoundCloudService_t qt_meta_stringdata_SoundCloudService = {
    {
QT_MOC_LITERAL(0, 0, 17), // "SoundCloudService"
QT_MOC_LITERAL(1, 18, 11), // "jobFinished"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "SoundCloudService\0jobFinished\0"
};
...
const QMetaObject SoundCloudService::staticMetaObject = {
    { &OnlineSearchService::staticMetaObject, qt_meta_stringdata_SoundCloudService.data,
      qt_meta_data_SoundCloudService,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SoundCloudService::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SoundCloudService.stringdata0))
        return static_cast<void*>(const_cast< SoundCloudService*>(this));
    return OnlineSearchService::qt_metacast(_clname);
}

int SoundCloudService::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = OnlineSearchService::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)

...
QT_MOC_LITERAL(1, 9, 13), // "itemsSelected"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 17), // "itemDoubleClicked"
QT_MOC_LITERAL(4, 42, 3), // "idx"
QT_MOC_LITERAL(5, 46, 16), // "correctSelection"
QT_MOC_LITERAL(6, 63, 21), // "showCustomContextMenu"
QT_MOC_LITERAL(7, 85, 3), // "pos"
QT_MOC_LITERAL(8, 89, 16) // "checkDoubleClick"

    },
    "ListView\0itemsSelected\0\0itemDoubleClicked\0"
    "idx\0correctSelection\0showCustomContextMenu\0"
    "pos\0checkDoubleClick"
};
...
void ListView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->correctSelection(); break;
        case 3: _t->showCustomContextMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 4: _t->checkDoubleClick((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef bool (ListView::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ListView::itemsSelected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ListView::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ListView::itemDoubleClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
bool ListView::itemsSelected(bool _t1)
{
    bool _t0 = bool();
...
// SIGNAL 1
void ListView::itemDoubleClicked(const QModelIndex & _t1)
{

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FolderPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FolderPage_t qt_meta_stringdata_FolderPage = {
    {
QT_MOC_LITERAL(0, 0, 10) // "FolderPage"
...
const QMetaObject FolderPage::staticMetaObject = {
    { &MultiPageWidget::staticMetaObject, qt_meta_stringdata_FolderPage.data,
      qt_meta_data_FolderPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FolderPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FolderPage.stringdata0))
        return static_cast<void*>(const_cast< FolderPage*>(this));

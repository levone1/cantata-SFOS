...
QT_MOC_LITERAL(1, 16, 8), // "resuming"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16), // "mpdStatusUpdated"
QT_MOC_LITERAL(4, 43, 15), // "prepareForSleep"
QT_MOC_LITERAL(5, 59, 1) // "s"

    },
    "PowerManagement\0resuming\0\0mpdStatusUpdated\0"
    "prepareForSleep\0s"
};
...
void PowerManagement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->resuming(); break;
        case 1: _t->mpdStatusUpdated(); break;
        case 2: _t->prepareForSleep((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (PowerManagement::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PowerManagement::resuming)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PowerManagement::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PowerManagement.data,
      qt_meta_data_PowerManagement,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
